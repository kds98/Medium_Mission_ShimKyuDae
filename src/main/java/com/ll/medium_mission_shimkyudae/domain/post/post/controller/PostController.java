package com.ll.medium_mission_shimkyudae.domain.post.post.controller;
...
public class PostController {
    ...
    @PostMapping("/write")
    public String postWrite(@RequestParam(value = "subject") String title, @RequestParam(value="content") String body) {
